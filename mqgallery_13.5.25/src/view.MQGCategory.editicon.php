...
$form = new MQGInputForm(56);
$form->setUrl('MQGCategory-'.$this->getValue('id').'-editicon');
...
echo '<div class="MQGCategoryEditicon">';
...
if(file_exists(MQGallery::getDir('originals').
  ...
  echo '<div><img src="'.$this->getIconSrc().'" /><a class="mqbutton"'.
    ' href="" onclick="MQGHelper.removeIcon(\'MQGCategory-'.$this->getValue('id').
      '\',\'MQGCategory-'.$this->getValue('id').'-editicon\');return false;">'.
